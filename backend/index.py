...
employees = """[
    ...
    { "name": "Eve", "skills": ["Cybersecurity", "Network Administration"], "availability": True },
    { "name": "Frank", "skills": ["DevOps", "Cloud Infrastructure"], "availability": False },
    { "name": "Grace", "skills": ["Frontend Development", "Graphic Design"], "availability": True },
    { "name": "Henry", "skills": ["Database Management", "Backend Development"], "availability": True },
    { "name": "Isabel", "skills": ["Data Science", "Machine Learning"], "availability": True },
    { "name": "Jack", "skills": ["Technical Support", "System Administration"], "availability": False }
]"""
